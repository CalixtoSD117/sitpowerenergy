...
const Home = () =>
{
  return (
    <div>
      <div classNameName='absolute z-50 '>
        <Navbar />
      </div>
      <div classNameName='pt-[78px]'>
        <Carrusel />
      </div>
      <div classNameName='mt-10'>
        <div classNameName='flex flex-col items-center'>
          <h1 classNameName='text-4xl font-semibold'>Nuestros Servicios</h1>
          <hr classNameName='w-80 m-2 border-green-200' />
        </div>
        <CardsServices />
      </div>
      <div>
